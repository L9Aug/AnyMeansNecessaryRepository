...
namespace UMA
{
    ...
    /// </remarks>
    public class OurHumanoidDNAConverterBehaviour : DnaConverterBehaviour
    {
        ...
        public override void Prepare()
        {
            ...
            positionHash = UMAUtils.StringToHash("Global");
            globalHash = UMAUtils.StringToHash("Global");
            lowerBackHash = UMAUtils.StringToHash("hips");
            headHash = UMAUtils.StringToHash("head");
            leftArmHash = UMAUtils.StringToHash("upper_arm_L");
            rightArmHash = UMAUtils.StringToHash("upper_arm_R");
            leftForeArmHash = UMAUtils.StringToHash("forearm_L");
            rightForeArmHash = UMAUtils.StringToHash("forearm_R");
            ...
            rightFootHash = UMAUtils.StringToHash("foor_R");
            leftUpLegHash = UMAUtils.StringToHash("thigh_L");
            rightUpLegHash = UMAUtils.StringToHash("thigh_R");
            leftShoulderHash = UMAUtils.StringToHash("shoulder_L");
            rightShoulderHash = UMAUtils.StringToHash("shoulder_R");
