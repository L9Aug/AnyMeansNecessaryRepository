...
/// </remarks>
public class OurFemaleDNAConverterBehaviour : OurHumanoidDNAConverterBehaviour
{
	public OurFemaleDNAConverterBehaviour()
	{
		this.ApplyDnaAction = UpdateUMAOurFemaleDNABones;
	...
	public static void UpdateUMAOurFemaleDNABones(UMAData umaData, UMASkeleton skeleton)
	{
