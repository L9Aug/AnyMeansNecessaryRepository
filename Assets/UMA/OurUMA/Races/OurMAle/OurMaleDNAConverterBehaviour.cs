...
/// </remarks>
public class OurMaleDNAConverterBehaviour : OurHumanoidDNAConverterBehaviour
{
	public OurMaleDNAConverterBehaviour()
	{
		this.ApplyDnaAction = UpdateUMAOurMaleDNABones;
	...
	public static void UpdateUMAOurMaleDNABones(UMAData umaData, UMASkeleton skeleton)
	{
